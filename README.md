...
- 🦞🧪 **[TensorClaw](https://github.com/pjo256/tensorclaw)** - Agentic research harness on top of [pi](https://github.com/badlogic/pi-mono): proposes focused code edits, runs experiments, keeps objective metric wins, reverts regressions with git, and logs every iteration in a durable ledger. Inspired by recent work and [@karpathy](https://github.com/karpathy)’s [autoresearch](https://github.com/karpathy/autoresearch).
...
- <img src="https://github.com/google.png" height="20" align="absmiddle"> **[tunix](https://github.com/google/tunix/pull/1179)** - Catch silent sample loss in micro-batches during JAX RL fine-tuning
